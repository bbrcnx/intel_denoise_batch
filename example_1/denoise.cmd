@echo off
:: By 王晓伟 https://github.com/bbrcnx/intel_denoise_batch
:: email: bbrcnx@gmail.com
...
:: 注意，如果没有albedo和normal层需要将下面两行删除。
...
:: 注意，如果没有albedo层和normal层需要将下面这部分字符删除 -alb  %pfm_albedo_folder%\%%~ng.pfm -nrm  %pfm_n_folder%\%%~ng.pfm 
